...
public final class Constants {
	...
	public static final Measure<Velocity<Distance>> SWERVE_DRIVE_MAX_SPEED = MetersPerSecond.of(5.2);
	...
	public static final Measure<Velocity<Angle>> MANUAL_SHOOTER_VELOCITY = RPM.of(2400); 
	public static final Measure<Velocity<Angle>> MANUAL_STORAGE_VELOCITY = RPM.of(575);
