...
public interface Constants {
	...
	double FRONT_LEFT_STEER_ENCODER_OFFSET = 28.212888;
	double FRONT_RIGHT_STEER_ENCODER_OFFSET = 88.681633;
	double BACK_LEFT_STEER_ENCODER_OFFSET = 78.574212;
	double BACK_RIGHT_STEER_ENCODER_OFFSET = 19.775389;
